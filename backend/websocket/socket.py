...
class WebSocketManager:
    ...
    def init_app(self, app):
        ...
        """
        self.socketio = SocketIO(app, cors_allowed_origins=["http://127.0.0.1:5500", "http://127.0.0.1:5501", "http://127.0.0.1:5502", "http://localhost:5500", "http://localhost:5501", "http://localhost:5502"], async_mode='threading')
